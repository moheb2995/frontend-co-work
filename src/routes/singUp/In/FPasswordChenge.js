  ...
  <div className="flex justify-center mt-24">
    <div className="card ">
      <div className="flex justify-between">
        ...
        <h2 className="text-2xl bold mt-4 ml-10">تغییر رمز عبور</h2>
        <Link to='/LoginNumber'><button className="text-4xl mt-2">{">"}</button></Link>
      </div>

      <h6 className='mx-20 px-2 mt-10'> رمز ورود جدید</h6>
      ...
      <div className="grid">
        <Link className='m-auto mt-10' to='/'><button className='btn-blue '>تایید </button></Link>
      </div>
    </div>
  </div>
</div>
)}
export default FPasswordChenge