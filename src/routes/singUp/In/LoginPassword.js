...
<div dir='rtl' className='h-[100vh]'>
  <div className="flex justify-center mt-24">
    <div className="card ">
      ...
      <div className="grid">
        <Link className='m-auto mt-10' to='/'><button className='btn-blue'>ورود </button></Link>
        <Link to='/FPasswordNum' className='text-[#00294D] text-center'><button className='inline-block border-[#00294D] border-b'>فراموشی رمز عبور</button></Link>
      </div>
    </div>
  </div>
</div>
